...
* **More configuration options** 
	...
	* In the same configuration file there are flags to disable the velocity and acceleration values. Only the linear velocity is enabled by default.  You can experiment with the linear acceleration and angular quantities if you like, but turning these on seems to crash SteamVR Home.   
